...
const ENGLISH: Strings = Strings {
    ...
    model_not_found_hint: "The folder should contain model.gguf.",
    model_not_found_error: "model.gguf not found in this directory!",
    confirm: "OK",
    none: "None",
};
...
const CHINESE: Strings = Strings {
    ...
    model_not_found_hint: "文件夹应包含 model.gguf。",
    model_not_found_error: "该目录下未找到 model.gguf！",
    confirm: "确定",
    none: "无",
};
