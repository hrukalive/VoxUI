...
pub struct Labels {
    ...
    pub send_mode_auto_gen: &'static str,
    pub send_mode_auto_gen_swap: &'static str,
...
pub fn labels(language: UiLanguage) -> Labels {
    match language {
        UiLanguage::Chinese => Labels {
            ...
            send_mode_auto_gen: "自动生成",
            send_mode_auto_gen_swap: "自动生成（替换）",
        ...
        UiLanguage::English => Labels {
            ...
            send_mode_auto_gen: "Auto Gen",
            send_mode_auto_gen_swap: "Auto Gen (Swap)",
